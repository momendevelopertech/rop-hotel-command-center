...
export const translations = {
  en: {
    ...
    "Link to Military ID": "Link to Military ID",
  ...
  ar: {
    ...
    "App Features Showcase": "ميزات التطبيق",
    "Booking via App": "الحجوزات عبر التطبيق",
    "Order Tracking": "تتبع الطلبات",
    "Push Notification Settings": "إعدادات الإشعارات",
    "Member Registration": "تسجيل الأعضاء",
    "Link to Military ID": "ربط الرقم العسكري",
